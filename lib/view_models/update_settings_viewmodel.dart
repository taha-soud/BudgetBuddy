    ...
    try {
      switch (detailType) {
        ...
        case 'Email':
          ...
          // String? emailAvailability = await Validator.validateEmailAvailability(newValue);  // Check email availability
          // if (emailAvailability != null) return emailAvailability;
